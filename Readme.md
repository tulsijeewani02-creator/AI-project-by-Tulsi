...
FOODPANDA PAKISTAN	1
CUSTOMER SEGMENTATION USING K-MEANS CLUSTERING	1
Final Project Report – AI for Business Course	1
EXECUTIVE SUMMARY	3
1. TITLE AND PROBLEM STATEMENT	4
TITLE:	4
PROBLEM STATEMENT:	4
2. BUSINESS BACKGROUND AND LITERATURE REVIEW	5
2.1 INDUSTRY OVERVIEW – ONLINE FOOD DELIVERY IN PAKISTAN	5
2.2 THE COMMISSION FEE CRISIS – A REAL BUSINESS PROBLEM	5
2.3 CUSTOMER SEGMENTATION IN FOOD DELIVERY	5
2.4 THEORETICAL FOUNDATION – K-MEANS CLUSTERING IN MARKETING	6
2.5 GAP THIS PROJECT ADDRESSES	6
3. DATASET DESCRIPTION	7
3.1 DATA SOURCE	7
3.2 DATASET SIZE AND STRUCTURE	7
3.3 COLUMN DESCRIPTIONS	7
3.4 CLUSTERING FEATURES – KEY STATISTICS	8
3.5 DATA PREPROCESSING SUMMARY	9
4. METHODOLOGY	9
4.1 OVERVIEW OF APPROACH	9
4.2 STEP-BY-STEP METHODOLOGY	9
4.3 TOOLS AND LIBRARIES USED	11
4.4 JUSTIFICATION OF MODEL CHOICE	12
5. RESULTS AND INTERPRETATION	12
5.1 BASELINE PERFORMANCE	12
5.2 K-SELECTION RESULTS (K=2 TO K=10)	12
5.3 FINAL CLUSTER PROFILES (K=3)	14
5.4 KEY INSIGHTS FROM RESULTS	16
6. BUSINESS RECOMMENDATIONS	17
6.1 SEGMENT 0 – HEAVY SPENDERS: VIP RE-ENGAGEMENT CAMPAIGN	17
6.2 SEGMENT 1 – CASUAL BROWSERS: HABIT-BUILDING & LOYALTY ONBOARDING	17
6.3 SEGMENT 2 – LOYAL ENGAGERS: REWARD ACTIVATION CAMPAIGN	18
7. CONCLUSION AND FUTURE IMPLICATIONS	19
7.1 SUMMARY OF FINDINGS	19
7.2 LIMITATIONS OF THIS STUDY	19
7.4 FINAL CONCLUSION	20
8. REFERENCES	21
9. APPENDIX – COMPLETE PYTHON CODE AND STEP-BY-STEP INSTRUCTIONS HOW I RUN THE DATA:	21
HTTPS://COLAB.RESEARCH.GOOGLE.COM/DRIVE/1LYQ2CY3HSUMU8CM-5USRWTMLVO9M8OHD?USP=SHARING	22
(THIS IS THE LINK OF GOOGLE COLAB WHERE I RUN THE CODE AND GOT RESULTS)	22
...
9. Appendix – Complete Python Code and Step-by-Step Instructions how I run the Data:
...
https://colab.research.google.com/drive/1Lyq2cy3hsuMu8cm-5USrWtMlvo9m8Ohd?usp=sharing 
